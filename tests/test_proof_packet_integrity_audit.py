...
class ProofPacketIntegrityAuditTest(unittest.TestCase):
    ...
    def test_passes_current_provenance_manifest(self) -> None:
        ...
        self.assertGreaterEqual(report["manifest_entry_count"], 309)
        self.assertGreaterEqual(report["evidence_artifact_count"], 149)
        self.assertGreaterEqual(report["source_input_count"], 156)
