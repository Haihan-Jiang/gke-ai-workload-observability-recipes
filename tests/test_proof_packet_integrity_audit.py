...
class ProofPacketIntegrityAuditTest(unittest.TestCase):
    ...
    def test_passes_current_provenance_manifest(self) -> None:
        ...
        self.assertGreaterEqual(report["manifest_entry_count"], 304)
        self.assertGreaterEqual(report["evidence_artifact_count"], 147)
        self.assertGreaterEqual(report["source_input_count"], 153)
