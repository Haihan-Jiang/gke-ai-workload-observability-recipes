...
class EvidenceSchemaAuditTest(unittest.TestCase):
    ...
    def test_passes_current_evidence_contracts(self) -> None:
        ...
        self.assertEqual(11, report["artifact_count"])
        self.assertGreaterEqual(report["required_field_count"], 90)
        self.assertGreaterEqual(report["required_check_count"], 70)
        self.assertGreaterEqual(report["metric_contract_count"], 50)
        self.assertEqual(11, report["detected_fixture_count"])
