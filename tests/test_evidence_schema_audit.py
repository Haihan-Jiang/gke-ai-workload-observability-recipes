...
class EvidenceSchemaAuditTest(unittest.TestCase):
    ...
    def test_passes_current_evidence_contracts(self) -> None:
        ...
        self.assertEqual(12, report["artifact_count"])
        self.assertGreaterEqual(report["required_field_count"], 103)
        self.assertGreaterEqual(report["required_check_count"], 76)
