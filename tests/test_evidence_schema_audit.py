...
class EvidenceSchemaAuditTest(unittest.TestCase):
    ...
    def test_passes_current_evidence_contracts(self) -> None:
        ...
        self.assertEqual(10, report["artifact_count"])
        self.assertGreaterEqual(report["required_field_count"], 80)
        self.assertGreaterEqual(report["required_check_count"], 60)
        self.assertGreaterEqual(report["metric_contract_count"], 40)
