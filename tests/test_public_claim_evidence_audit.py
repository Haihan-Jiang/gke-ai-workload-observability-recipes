...
class PublicClaimEvidenceAuditTest(unittest.TestCase):
    ...
    def test_current_public_claim_evidence_passes(self) -> None:
        ...
        self.assertGreaterEqual(report["claim_count"], 15)
        self.assertGreaterEqual(report["evidence_claim_count"], 15)
        self.assertGreaterEqual(report["release_check_count"], 15)
