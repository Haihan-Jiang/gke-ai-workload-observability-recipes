...
class ValidationContractAuditTest(unittest.TestCase):
    ...
    def test_current_validation_contract_passes(self) -> None:
        ...
        self.assertGreaterEqual(report["py_compile_script_count"], 71)
        self.assertGreaterEqual(report["generation_script_count"], 69)
        self.assertGreaterEqual(report["direct_validation_script_count"], 68)
        self.assertGreaterEqual(report["policy_json_count"], 64)
        self.assertGreaterEqual(report["committed_json_count"], 79)
        self.assertGreaterEqual(report["release_argument_count"], 68)
