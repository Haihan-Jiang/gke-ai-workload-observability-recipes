...
- Py-compiled demo scripts: `72`
- Generation scripts: `70`
- Direct validation scripts: `69`
- Policy JSON files validated: `65`
- Committed evidence JSON files validated: `80`
- Release-readiness arguments: `69`
