...
- Py-compiled demo scripts: `69`
- Generation scripts: `67`
- Direct validation scripts: `66`
- Policy JSON files validated: `62`
- Committed evidence JSON files validated: `77`
- Release-readiness arguments: `66`
