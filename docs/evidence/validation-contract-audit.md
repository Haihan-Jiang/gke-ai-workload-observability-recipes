...
- Py-compiled demo scripts: `68`
- Generation scripts: `66`
- Direct validation scripts: `65`
- Policy JSON files validated: `61`
- Committed evidence JSON files validated: `76`
- Release-readiness arguments: `65`
