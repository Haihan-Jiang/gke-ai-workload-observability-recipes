...
normal traffic, cache-miss latency, dependency timeout, and rollout regression
scenarios, then evaluates whether the generated signals match SRE
expectations.
...
> delivery, incident narratives, and SLO-style reliability gates.
