...
REQUIRED_EVIDENCE = [
    ...
    "threat-model-audit.json",
    "data-handling-audit.md",
    ...
    *,
    ...
    checks = [
        ...
        },
        {
            ...
            and int(release_control_ownership.get("control_count", 0)) >= 68
            ...
            and int(release_control_ownership.get("tier0_count", 0)) >= 45
            and int(release_control_ownership.get("every_release_count", 0)) >= 56
        ...
        },
        {
            ...
            and int(control_traceability.get("control_count", 0)) >= 63
            and int(control_traceability.get("evidence_file_count", 0)) >= 127
            and int(control_traceability.get("source_input_count", 0)) >= 66
            and int(control_traceability.get("policy_input_count", 0)) >= 64
            and int(control_traceability.get("test_file_count", 0)) >= 63
        ...
        },
        {
            ...
            and int(evidence_pipeline.get("step_count", 0)) >= 70
            and int(evidence_pipeline.get("dependency_count", 0)) >= 186
            and int(evidence_pipeline.get("artifact_dependency_count", 0)) >= 186
        ...
        },
        {
            ...
            and int(evidence_schema.get("artifact_count", 0)) >= 23
            and int(evidence_schema.get("required_field_count", 0)) >= 259
            and int(evidence_schema.get("required_check_count", 0)) >= 154
            and int(evidence_schema.get("detected_fixture_count", 0)) >= 23
            and int(evidence_schema.get("failed_count", -1)) == 0,
        },
        {
            "name": "validation_contract_audit",
            "ok": validation_contract.get("status") == "pass"
            and int(validation_contract.get("py_compile_script_count", 0)) >= 72
            and int(validation_contract.get("generation_script_count", 0)) >= 70
            and int(validation_contract.get("direct_validation_script_count", 0)) >= 69
            and int(validation_contract.get("policy_json_count", 0)) >= 65
            and int(validation_contract.get("committed_json_count", 0)) >= 80
            and int(validation_contract.get("release_argument_count", 0)) >= 69
        ...
        },
        {
            ...
            and int(disaster_recovery_drill.get("artifact_count", 0)) >= 142
        ...
        {
            "name": "threat_model_audit",
            "ok": threat_model.get("status") == "pass"
            and int(threat_model.get("present_file_count", 0)) >= 5
            and int(threat_model.get("asset_count", 0)) >= 6
            and int(threat_model.get("trust_boundary_count", 0)) >= 6
            and int(threat_model.get("threat_count", 0)) >= 6
            and int(threat_model.get("mitigation_count", 0)) >= 19
            and int(threat_model.get("residual_risk_count", 0)) >= 6
            and int(threat_model.get("evidence_link_count", 0)) >= 19
            and int(threat_model.get("existing_evidence_link_count", 0)) >= 19
            and int(threat_model.get("release_control_count", 0)) >= 19
            and int(threat_model.get("detected_fixture_count", 0)) >= 7
            and int(threat_model.get("failed_count", -1)) == 0,
        },
        {
            "name": "data_handling_audit",
            "ok": data_handling.get("status") == "pass"
            and int(data_handling.get("present_file_count", 0)) >= 6
            and int(data_handling.get("data_class_count", 0)) >= 6
            and int(data_handling.get("handling_term_count", 0)) >= 54
            and int(data_handling.get("retention_term_count", 0)) >= 6
            and int(data_handling.get("owner_count", 0)) >= 6
            and int(data_handling.get("evidence_link_count", 0)) >= 18
            and int(data_handling.get("existing_evidence_link_count", 0)) >= 18
            and int(data_handling.get("release_control_count", 0)) >= 18
            and int(data_handling.get("detected_fixture_count", 0)) >= 7
            and int(data_handling.get("failed_count", -1)) == 0,
        },
        {
            "name": "public_claim_evidence_audit",
            "ok": public_claim_evidence.get("status") == "pass"
            and int(public_claim_evidence.get("claim_count", 0)) >= 17
            and int(public_claim_evidence.get("evidence_claim_count", 0)) >= 17
            and int(public_claim_evidence.get("release_check_count", 0)) >= 17
        ...
        },
        {
            ...
            and int(evidence_provenance.get("artifact_count", 0)) >= 153
            and int(evidence_provenance.get("source_input_count", 0)) >= 162
        ...
        },
        {
            ...
            and int(proof_packet_integrity.get("manifest_entry_count", 0)) >= 319
            and int(proof_packet_integrity.get("evidence_artifact_count", 0)) >= 153
            and int(proof_packet_integrity.get("generated_artifact_count", 0)) >= 4
            and int(proof_packet_integrity.get("source_input_count", 0)) >= 162
...
def write_markdown(report: dict[str, Any], output_dir: Path) -> None:
    ...
    lines = [
        ...
        "drill coverage, documentation link integrity, architecture decisions, reviewer reproducibility, threat modeling, data handling, maintainer intake, public claim evidence, release notes contract, evidence provenance, proof-packet integrity, and committed evidence are",
